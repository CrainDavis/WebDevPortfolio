            ...
            <img src={images[project.num]} className="project-img card-img-top" alt={project.id}></img>
                <div className="card-body">
                    ...
                    <span className="d-flex justify-content-around">
                        <a className="project-link-btn" href={project.app_href} target="__blank">see app→</a>
                        <a className="project-link-btn" href={project.gh_href} target="__blank">see repo→</a>
                    </span>
                </div>
            </div>
        ))}
